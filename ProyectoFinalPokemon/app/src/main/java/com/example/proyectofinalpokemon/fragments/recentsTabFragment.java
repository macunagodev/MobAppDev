 ...
 */
public class recentsTabFragment extends Fragment implements OnPokemonClicked {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_recents_tab, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.pokemonRecentRecyclerView);
        InitRecyclerView();
    }
